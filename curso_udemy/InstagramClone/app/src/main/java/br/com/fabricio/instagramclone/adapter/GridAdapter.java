...
public class GridAdapter extends ArrayAdapter<String> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            viewHolder.imagem = convertView.findViewById(R.id.list_item_postagem_imagem);
            viewHolder.progressBar = convertView.findViewById(R.id.list_item_postagem_progressBar);
